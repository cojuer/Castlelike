...
void CutscenePlayer::finishCutscene()
{
    for (auto& fragment : m_currentCutscene->getFragments())
    {
        if (!fragment->hasFinished())
...
bool CutscenePlayer::onCutscene() const
{
