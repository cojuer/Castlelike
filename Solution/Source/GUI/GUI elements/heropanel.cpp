...
void HeroPanel::init(ResourceManager& resManager, SystemManager& sysManager)
{
    auto texture = resManager.get<Renderable>("hero_test_portrait_texture");
    ...
    texture = resManager.textRenderer->renderTexture(hero.getRes(), fName, fSize, fColor);
    widget = new Widget("name", this, 35, 90, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Strength", fName, fSize, fColor);
    widget = new Widget("str", this, 20, 120, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Dexterity", fName, fSize, fColor);
    widget = new Widget("dex", this, 20, 140, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Intelligence", fName, fSize, fColor);
    widget = new Widget("int", this, 20, 160, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Vitality", fName, fSize, fColor);
    widget = new Widget("vit", this, 20, 180, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Charisma", fName, fSize, fColor);
    widget = new Widget("chr", this, 20, 200, true, texture);
    addChild(*widget);

    texture = resManager.textRenderer->renderTexture("Perception", fName, fSize, fColor);
    ...
    texture = resManager.textRenderer->renderTexture("Damage", fName, fSize, fColor);
    addChild(*new Widget("dmg", this, 200, 120, true, texture));

    texture = resManager.get<Renderable>("ph_dmg");
    ...
    texture = resManager.get<Renderable>("m_dmg");
    ...
    texture = resManager.get<Renderable>("f_dmg");
    ...
    texture = resManager.get<Renderable>("fr_dmg");
    ...
    texture = resManager.get<Renderable>("l_dmg");
    ...
    texture = resManager.get<Renderable>("p_dmg");
    ...
    texture = resManager.get<Renderable>("ch_dmg");
    ...
    texture = resManager.textRenderer->renderTexture("Resistance", fName, fSize, fColor);
    ...
    texture = resManager.textRenderer->renderTexture("Armor", fName, fSize, fColor);
