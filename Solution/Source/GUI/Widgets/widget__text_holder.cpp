...
void TextOwnerWidget::render(RenderSubsystem& rendSubsys, ResourceSystem& resSystem, Vec2i coordStart) const
{
    auto texture = resSystem.textRenderer->renderTexture(m_text, m_rendInfo.m_font, m_rendInfo.m_fontSize, m_rendInfo.m_color, m_geometry.w);
    SDL_Rect dstRect = { 
